...
<body>
    ...
    <div class="contenedor_alternativa">
        ...
        <div class="caja" draggable="true" ondragstart="drag(event)" id="c">28</div>
        <div class="caja" draggable="true" ondragstart="drag(event)" id="d">14</div>
        <div class="caja" draggable="true" ondragstart="drag(event)" id="e">1.25</div>
        <div class="caja" draggable="true" ondragstart="drag(event)" id="f">2.5</div>
    </div>
    <br>
    <br>
    <div class="resultado">
